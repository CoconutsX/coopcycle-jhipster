...
describe('Customer e2e test', () => {
  ...
  const customerSample = { iD: 74229, address: 'leading backing SSL' };
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      cy.get(`[data-cy="iD"]`).type('36761').should('have.value', '36761');

      cy.get(`[data-cy="name"]`).type('architectures circuit Avon').should('have.value', 'architectures circuit Avon');

      cy.get(`[data-cy="surname"]`).type('olive Uruguayo overriding').should('have.value', 'olive Uruguayo overriding');

      cy.get(`[data-cy="phone"]`).type('0716383531').should('have.value', '0716383531');

      cy.get(`[data-cy="address"]`).type('Lek Wooden').should('have.value', 'Lek Wooden');
