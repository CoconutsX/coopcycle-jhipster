...
describe('Product e2e test', () => {
  ...
  const productSample = { iDProduct: 32411, iDMenu: 85423 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="iDProduct"]`).type('52048').should('have.value', '52048');

      cy.get(`[data-cy="iDMenu"]`).type('6748').should('have.value', '6748');

      cy.get(`[data-cy="name"]`).type('Tasty').should('have.value', 'Tasty');

      cy.get(`[data-cy="price"]`).type('5234').should('have.value', '5234');

      cy.get(`[data-cy="stock"]`).type('98967').should('have.value', '98967');
