...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getiD()).isEqualTo(DEFAULT_I_D);
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.iD(UPDATED_I_D).name(UPDATED_NAME).surname(UPDATED_SURNAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getiD()).isEqualTo(UPDATED_I_D);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.iD(UPDATED_I_D).address(UPDATED_ADDRESS);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.iD(UPDATED_I_D).name(UPDATED_NAME).surname(UPDATED_SURNAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
