...
import info4.gl.dm.coopcycle.repository.PaymentRepository;
import info4.gl.dm.coopcycle.service.dto.PaymentDTO;
import info4.gl.dm.coopcycle.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    private static final PaymentMethod DEFAULT_METHOD = PaymentMethod.CB;
    private static final PaymentMethod UPDATED_METHOD = PaymentMethod.PAYPAL;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().method(DEFAULT_METHOD).ammount(DEFAULT_AMMOUNT);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().method(UPDATED_METHOD).ammount(UPDATED_AMMOUNT);
        return payment;
    }
    ...
    @Test
    void checkAmmountIsRequired() throws Exception {
        int databaseSizeBeforeTest = paymentRepository.findAll().collectList().block().size();
        // set the field null
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.method(UPDATED_METHOD).ammount(UPDATED_AMMOUNT);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.ammount(UPDATED_AMMOUNT);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.method(UPDATED_METHOD).ammount(UPDATED_AMMOUNT);
