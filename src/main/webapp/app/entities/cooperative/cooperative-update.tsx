        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('coopcycleApp.cooperative.phone')}
              ...
              />
              <ValidatedField
                label={translate('coopcycleApp.cooperative.address')}
              ...
              />
              <ValidatedField
                label={translate('coopcycleApp.cooperative.webURL')}
                id="cooperative-webURL"
                name="webURL"
                data-cy="webURL"
                type="text"
              />
