...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYPERSON_LIST actions', async () => {
    ...
    it('dispatches FETCH_DELIVERYPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERYPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERYPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERYPERSON actions', async () => {
      const expectedActions = [
        {
