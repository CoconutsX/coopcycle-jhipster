...
import info4.gl.dm.coopcycle.service.PaymentService;
...
/**
 * REST controller for managing {@link info4.gl.dm.coopcycle.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
     ...
     */
    @GetMapping(value = "/payments", produces = MediaType.APPLICATION_NDJSON_VALUE)
